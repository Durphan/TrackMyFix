...
public class UserChangeDataLoader {
    ...
    public void load() {
        ...
        UserChange userChange1 = new UserChange(null, ActionUser.AGREGO_CLIENTE, technicians.get(0), clients.get(0),
                null);
        UserChange userChange2 = new UserChange(null, ActionUser.MODIFICO_DATOS_CLIENTE, technicians.get(1),
                clients.get(0), null);
        UserChange userChange3 = new UserChange(null, ActionUser.AGREGO_CLIENTE, technicians.get(2), clients.get(0),
                null);
        UserChange userChange4 = new UserChange(null, ActionUser.DESACTIVO_CUENTA_CLIENTE, technicians.get(0),
                clients.get(3), null);
        UserChange userChange5 = new UserChange(null, ActionUser.MODIFICO_DATOS_CLIENTE, technicians.get(1),
                clients.get(4), null);
